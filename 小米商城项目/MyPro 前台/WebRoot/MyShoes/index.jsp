	...
	<!-- start header -->
		<header>
			<div class="top center">
				...
				<div class="right fr">
					<div class="gouwuche fr"><a href="ShopCar.jsp">购物车</a></div>
					<div class="fr">
						<ul>
						<c:choose>
		...
		<div class="banner_x center">
			...
			<div class="nav fl">
				<ul>
					...
					<li><a href="../liebiao.do?type=盒子·影音">盒子·影音</a></li>
			...
			<div class="search fr">
				<form action="../liebiao.do" method="post">
					...
					<div class="submit fl">
						<input type="submit" class="sousuo" value="搜索" name="key"/>
					</div>
					<div class="clear"></div>
				</form>
				<div class="clear"></div>
		...
		<div class="danpin center">
			...
			<c:forEach items="${list }" var="shoes">
				<div class="mingxing fl">
					<div class="sub_mingxing"><a href="../info.do?method=shoes&shoesid=${shoes.shoesid}"><img src="./image/${shoes.shoesimg}" alt=""></a></div>
					<div class="pinpai"><a href="../info.do?method=shoes&shoesid=${shoes.shoesid}">${shoes.shoesname}</a></div>
					<div class="youhui">${shoes.shoesintr}</div>
					<div class="jiage">${shoes.shoesprice}</div>
				</div>
				</c:forEach>
				<div class="clear"></div>
			</div>
